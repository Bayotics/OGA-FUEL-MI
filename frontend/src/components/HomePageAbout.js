import aboutImg from '../assets/Fuel-me/pngs/home-about.png'
...
const HomePageAbout = () => {
    return(
        <div className="border px-16 flex justify-between mt-10 pt-6">
            <div className="home-about-texts w-1/2 border">
                ...
                <div className="home-about-btn mt-8 border">
                    <button className="border bg-[#000000] px-7 py-3 rounded-md text-white hover:bg-[#4c4d4e]">
                        Learn More →
                    </button>
                </div>
            ...
            <div className="home-about-design w-1/2 pl-6 border">
                <div className='home-about-item border flex gap-8'>
                    <div className='border'>
                        <div className='rounded-full border p-3 bg-black'>
                    ...
                    <div className='border px-4 mt-2'>
                ...
                <div className='home-about-item border flex gap-8 mt-8'>
                    <div className='border'>
                        <div className='rounded-full border p-3 bg-black'>
