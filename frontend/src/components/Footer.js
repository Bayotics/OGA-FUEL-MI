            ...
            <div>
                <div className="footer-contents  -t pt-16 pb-8 px-32 flex justify-between">
                    ...
                    <div className="footer-menu   mt-1">
                        <h1 className="text-xl font-medium footer-heading text-[#1a2eeb]">Company</h1>
                        <div className="mt-4">
                            <Link to= '/about'>
                    ...
                    <div className="footer-menu   mt-1">
                        <h1 className="text-xl footer-heading font-medium text-[#1a2eeb]">Quick Links</h1>
                        <div className="mt-4">
                        <Link to= '/contact'>
                    ...
                    <div className="footer-title-social  ">
                        <h1 className="text-xl font-medium footer-heading text-[#1a2eeb]">Socials</h1>
